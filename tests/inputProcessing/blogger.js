...
// module being tested
var blogger = require('../../modules/inputProcessing/blogger');

// test data
var url = 'http://interestingwebs.blogspot.de/';
var corpus = {
    _id: 'test',
    input: url,
    input_count: 50
...
describe('Blogger input processing suit', function () {
    it('should get 50 results', function (done) {
        blogger.process(corpus)
        .then(function(res){
            // check length
